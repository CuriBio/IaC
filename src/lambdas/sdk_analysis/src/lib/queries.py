...
INSERT_INTO_MANTARRAY_RECORDING_SESSIONS = """
    INSERT INTO mantarray_recording_sessions(mantarray_recording_session_id, customer_account_id, user_account_id, instrument_serial_number, acquisition_started_at, length_centimilliseconds,
